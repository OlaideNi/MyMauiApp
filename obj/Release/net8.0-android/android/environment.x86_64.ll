...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 600, ; uint32_t number_of_dso_cache_entries (0x258)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [600 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.69_name, ; name: libaot-System.Net.Http.Json.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.94_name, ; name: libaot-System.Xml.Linq.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4026954999397231506, ; hash 0x37e29e3c798e2b92, from name: libaot-interviewMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 128
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-System.Xml.XDocument.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7250387870933883501, ; hash 0x649e8d5abad09a6d, from name: interviewMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	...
	%struct.DSOCacheEntry {
		i64 9349918178519939633, ; hash 0x81c1950b9da5fa31, from name: aot-interviewMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 299
	...
	%struct.DSOCacheEntry {
		i64 13245631282065695059, ; hash 0xb7d1ef790153e153, from name: aot-interviewMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 433
	...
	%struct.DSOCacheEntry {
		i64 13458914488161005242, ; hash 0xbac7ab6b2931eeba, from name: libaot-interviewMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 439
	...
	%struct.DSOCacheEntry {
		i64 15590796518334703929, ; hash 0xd85da2d470bca939, from name: interviewMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 513
...
@.env.3 = private unnamed_addr constant [37 x i8] c"5b2d690b-ccfa-4069-8561-ab52f2123350\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.interviewmobile\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [30 x i8] c"libaot-interviewMobile.dll.so\00", align 16
...
@.DSOCacheEntry.69_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.Http.Json.dll.so\00", align 16
...
@.DSOCacheEntry.94_name = private unnamed_addr constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 16
@.DSOCacheEntry.95_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.96_name = private unnamed_addr constant [35 x i8] c"libaot-System.Xml.XDocument.dll.so\00", align 16
