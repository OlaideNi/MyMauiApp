...
@dso_cache = dso_local local_unnamed_addr global [600 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 251081240, ; hash 0xef73218, from name: libaot-interviewMobile.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1315149055, ; hash 0x4e6394ff, from name: interviewMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 169
	...
	%struct.DSOCacheEntry {
		i64 2988667333, ; hash 0xb22371c5, from name: interviewMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 432
	...
	%struct.DSOCacheEntry {
		i64 3440475199, ; hash 0xcd117c3f, from name: libaot-interviewMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 489
	...
	%struct.DSOCacheEntry {
		i64 3636907840, ; hash 0xd8c6cf40, from name: aot-interviewMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 513
	...
	%struct.DSOCacheEntry {
		i64 4137063072, ; hash 0xf69692a0, from name: aot-interviewMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-interviewMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 579
